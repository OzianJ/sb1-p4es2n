    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 mb-8 md:mb-0">
                <img src="https://images.unsplash.com/photo-1532619187608-e5375cab36aa?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Research team" class="rounded-lg shadow-md">
            </div>
            <div class="md:w-1/2 md:pl-12">
                <h2 class="text-3xl font-bold mb-4">About ARSS</h2>
                ...
                <a href="#" class="text-blue-600 font-semibold hover:underline">Learn more about our team</a>
            </div>
        </div>
    </div>
</section>